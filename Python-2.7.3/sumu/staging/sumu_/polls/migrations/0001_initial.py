...
class Migration(SchemaMigration):
    ...
    def backwards(self, orm):
        ...
        db.delete_table(u'cmsplugin_pollplugin')
    ...
    models = {
        ...
        u'polls.pollplugin': {
            'Meta': {'object_name': 'PollPlugin', 'db_table': "u'cmsplugin_pollplugin'", '_ormbases': ['cms.CMSPlugin']},
            u'cmsplugin_ptr': ('django.db.models.fields.related.OneToOneField', [], {'to': "orm['cms.CMSPlugin']", 'unique': 'True', 'primary_key': 'True'}),
            'poll': ('django.db.models.fields.related.ForeignKey', [], {'related_name': "'plugins'", 'to': u"orm['polls.Poll']"})
        }
    }

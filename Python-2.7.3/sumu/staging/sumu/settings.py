...
ALLOWED_HOSTS = [
    'sumu.synapse-computing.com',
    'ldata.synapse-computing.com',
    '127.0.0.1',
]
...
TEMPLATE_DIRS = (
    ...
    os.path.join(PROJECT_PATH, "templates/djubby"),
)
...
EMAIL_HOST_USER = 'suomenmuinaistaideseura@gmail.com'
EMAIL_HOST_PASSWORD = 'orionterrime'
EMAIL_PORT = 587

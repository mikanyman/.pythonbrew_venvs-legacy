...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'Teaser'
        db.create_table(u'cmsplugin_teaser', (
        ...
        db.send_create_signal(u'teaser', ['Teaser'])


    def backwards(self, orm):
        # Deleting model 'Teaser'
        db.delete_table(u'cmsplugin_teaser')
    ...
    models = {
        ...
        u'teaser.teaser': {
            'Meta': {'object_name': 'Teaser', 'db_table': "u'cmsplugin_teaser'", '_ormbases': ['cms.CMSPlugin']},

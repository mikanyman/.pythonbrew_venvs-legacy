...
if os.name == 'nt':
    MEDIA_ROOT = 'C:/cygwin/home/mnyman/development/sumu_arkestra_01/dev_01/sumu/media/'
else:
    MEDIA_ROOT = BASE_PATH + '/media/'
...
#STATIC_ROOT = "/home/mnyman/.pythonbrew/venvs/Python-2.7.3/sumu-arkestra-01/staging/sumu/sitestatic/"
...
if os.name == 'nt':
    STATICFILES_DIRS = (
        ...
        'C:/cygwin/home/mnyman/development/sumu_arkestra_01/dev_01/sumu/media/filer',
    )
else:
    STATICFILES_DIRS = (
        # Put strings here, like "/home/html/static" or "C:/www/django/static".
...
if os.name == 'nt':
    TEMPLATE_DIRS = (
        BASE_PATH + '\\templates\\',
        'C:\\Python27\\src\\semanticeditor\\semanticeditor\\templates',
        'C:\\Python27\\Lib\\site-packages\\django_filer-0.9.4a1.dev1-py2.7.egg\\filer\\templates'
    )
else:
    TEMPLATE_DIRS = (
        BASE_PATH + "/templates/"
...
# /home/mnyman/.pythonbrew/venvs/Python-2.7.3/sumu-arkestra-01/src/arkestra/arkestra_utilities/settings.py
